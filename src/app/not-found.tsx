...
=======
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#000]">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute top-20 left-20 h-32 w-32 rounded-full border border-[#D1A04D]/20"></div>
        <div className="absolute right-32 bottom-40 h-48 w-48 rounded-full border border-[#D1A04D]/10"></div>
        <div className="absolute top-1/2 right-20 h-24 w-24 rounded-full border border-[#D1A04D]/15"></div>
      </div>

      <div className="relative z-10 mx-auto px-6 text-center">
        {/* 404 Number */}
        <div className="mb-8">
          <h1 className="bg-gradient-to-r from-[#D1A04D] via-[#E6B85C] to-[#D1A04D] bg-clip-text text-9xl leading-none font-bold text-transparent md:text-[12rem]">
            404
          </h1>
>>>>>>> dbe9b69 (all section added)
        </div>
...
<<<<<<< HEAD
          ...
          <p className="font-montserrat__alternates mx-auto max-w-2xl text-base leading-relaxed text-[#666666] md:text-lg">
            ...
            cuisine!
=======
          <h2 className="font-josefin_Sans mb-6 text-4xl leading-tight font-[500] text-[#D1A04D] md:text-5xl">
            Oops! This page seems to be
            <span className="block text-[#E6E6E6]">off the menu</span>
          </h2>
          <p className="font-poppins mx-auto max-w-2xl text-lg leading-relaxed font-[300] text-[#E6E6E6] md:text-xl">
            We couldn&apos;t find the page you&apos;re looking for. It might
...
<<<<<<< HEAD
          ...
          <Link href={'/menu'}>
            <button className="font-montserrat__alternates group flex items-center gap-3 rounded-full border-2 border-[#A9861B] px-8 py-4 font-bold text-[#A9861B] uppercase transition-all duration-300 hover:bg-[#A9861B] hover:text-white">
              ...
              View Menu
=======
            <button className="font-open_Sans group flex transform items-center gap-3 rounded-full bg-[#D1A04D] px-8 py-4 font-[600] text-[#000] uppercase shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#E6B85C]">
              <Home size={20} />
              Back to Home
...
=======
      ...
      {/* Floating Particles */}
      <div className="absolute top-1/4 left-10 h-2 w-2 animate-bounce rounded-full bg-[#D1A04D] delay-1000"></div>
      <div className="absolute top-3/4 right-20 h-1 w-1 animate-bounce rounded-full bg-[#E6B85C] delay-500"></div>
      <div className="absolute top-1/2 left-1/4 h-1.5 w-1.5 animate-bounce rounded-full bg-[#D1A04D]/80 delay-700"></div>
>>>>>>> dbe9b69 (all section added)
    </div>
  );
};
